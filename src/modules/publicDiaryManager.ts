...
export const addDiary = createAction('publicDiary/ADD')<diaryData>();
export const removeDiary = createAction('publicDiary/REMOVE')<diaryData>();
export const modifyDiary = createAction('publicDiary/MODIFY')<diaryData>(); // payload 타입을 Generics 로 설정해주세요.
export const fetchMoreDiary = createAction('publicDiary/FETCHMORE')<Array<diaryData>>(); 
export const fetchDiary = createAction('publicDiary/FETCH')<Array<diaryData>>(); 
